...
% in LaTeX
% 2021/04/20 - fifth version sent to Compositionality: version for publication

\documentclass[ a4paper, onecolumn, superscriptaddress,10pt, accepted=2022-03-25, issue=3, volume=4, shorttitle=papers/compositionality-4-3 ]{compositionalityarticle}
\pdfoutput=1

% journal reference: Compositionality 4, 3 (2022)
% DOI: 10.32408/compositionality-4-3


\usepackage{amssymb,amsmath,stmaryrd,mathrsfs,amsthm}%,undertilde}
\usepackage{comment}
...
%=== compatible text and math fonts
