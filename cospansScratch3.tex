...
%\node (B3) at (4,0) {$\scriptscriptstyle{B3}$};
...
%(B3) edge node[above]{$\scriptscriptstyle{}$} (B4)
...
%\node (R) at (6.5,0.5) {$\scriptstyle{\cong}$};
...
%\node (A5) at (8,1) {$\scriptscriptstyle{F'(H(m_1+m_2))}$};
%\node (A6) at (10,1) {$\scriptscriptstyle{A6}$};
%\node (A7) at (12,1) {$\scriptscriptstyle{A7}$};
...
%\node (B5) at (8,0) {$\scriptscriptstyle{B5}$};
%\node (B6) at (10,0) {$\scriptscriptstyle{B6}$};
%\node (B7) at (12,0) {$\scriptscriptstyle{B7}$};
\path[->,font=\scriptsize,>=angle 90]
...
%(A4) edge node [above] {$\scriptscriptstyle{F'(H_{m_1,m_2})}$} (A5)
...
%(B3) edge node [fill=white] {$\scriptscriptstyle{\theta_{m_1+m_2}}$} (A5)
...
%\node (A6) at (10,2) {$\scriptscriptstyle{F'(H(m_1+m_2)+H(m_3))}$};
%\node (A7) at (12,2) {$\scriptscriptstyle{F'(H((m_1+m_2)+m_3))}$};
...
%\node (B6) at (10,0) {$\scriptscriptstyle{F'(H(m_1)+H(m_2+m_3))}$};
%\node (B7) at (12,0) {$\scriptscriptstyle{F'(H(m_1+(m_2+m_3)))}$};
...
%\node (C7) at (12,-1) {$\scriptscriptstyle{C7}$};
...
%\node (D6) at (10,-2) {$\scriptscriptstyle{D6}$};
%\node (D7) at (12,-2) {$\scriptscriptstyle{D7}$};
\path[->,font=\scriptsize,>=angle 90]
...
%(A5) edge node [above] {$\scriptscriptstyle{\phi'_{H(m_1+m_2),H(m_3)}}$} (A6)
%(A6) edge node [above] {$\scriptscriptstyle{F'(H_{m_1+m_2,m_3})}$} (A7)
...
%(B5) edge node [above] {$\scriptscriptstyle{\phi'_{H(m_1),H(m_2+m_3)}}$} (B6)
%(B6) edge node [above] {$\scriptscriptstyle{F'(H_{m_1,m_2+m_3})}$} (B7)
...
%(D5) edge node [above] {$$} (D6)
%(D6) edge node [above] {$$} (D7);
\end{tikzpicture}
\]
\noindent
...
%\node (B4) at (8,0) {$\scriptscriptstyle{B4}$};
%\node (B5) at (8,0) {$\scriptscriptstyle{B5}$};
%\node (B6) at (10,0) {$\scriptscriptstyle{B6}$};
\path[->,font=\scriptsize,>=angle 90]
...
%(A5) edge node[above]{$\scriptscriptstyle{}$} (A6)

(A5) edge node [fill=white] {$\scriptscriptstyle{F'(\ell)}$} (B3)
%(B2) edge node [fill=white] {$\scriptscriptstyle{\phi'_0 \times 1}$} (A3)
...
%(B3) edge node[above]{$\scriptscriptstyle{}$} (B4)
%(B4) edge node[above]{$\scriptscriptstyle{}$} (B5)
%(B5) edge node[above]{$\scriptscriptstyle{}$} (B6);
\end{tikzpicture}
\]
Right, down and then left:
\[
...
%\node (A5) at (8,1) {$\scriptscriptstyle{A5}$};
%\node (A6) at (10,1) {$\scriptscriptstyle{A6}$};
...
%\node (B4) at (6,0) {$\scriptscriptstyle{B4}$};
%\node (B5) at (8,0) {$\scriptscriptstyle{B5}$};
%\node (B6) at (10,0) {$\scriptscriptstyle{B6}$};
\path[->,font=\scriptsize,>=angle 90]
(0) edge node [fill=white] {$\scriptscriptstyle{1 \times \phi''_0}$} (A1)
...
%(A4) edge node[above]{$\scriptscriptstyle{}$} (A5)
%(A5) edge node[above]{$\scriptscriptstyle{}$} (A6)
...
%(B2) edge node [fill=white] {$\scriptscriptstyle{\phi'_0 \times 1}$} (A2)

(C5) edge node [fill=white] {$\scriptscriptstyle{F'(H(\ell))}$} (D3)
(C4) edge node [fill=white] {$\scriptscriptstyle{E(F((\ell))}$} (D2)
%(D') edge node [left] {$\scriptscriptstyle{E(\ell)}$} (D2)
%(D') edge node [left] {$\scriptscriptstyle{E(\phi_0 \times 1)}$} (C3)
%(C1) edge node [fill=white] {$\scriptscriptstyle{E(\ell)}$} (D1)
...
%(A4) edge node [right] {$\scriptscriptstyle{F'(H_{m,n})}$} (B4)
...
%\node (A8) at (10.5,1.8) {$\scriptscriptstyle{F'H(m+_b n)+p}$};
%\node (A9) at (12,1.8) {$\scriptscriptstyle{F'H(m+_b n)+_c p}$};

\node (A') at (8,1) {$\scriptscriptstyle{F'((H(m)+H(n))+H(p))}$};
%\node (A'') at (8,0.6) {$\scriptscriptstyle{F'H(m+n)+p}$};
%\node (A''') at (8,0.2) {$\scriptscriptstyle{F'Hm+(n+p)}$};
...
%\node (B8) at (10.5,-1) {$\scriptscriptstyle{F'Hm+(n+_c p)}$};
%\node (B9) at (12,-1) {$\scriptscriptstyle{F'Hm+_b (n+_c p)}$};

\node (C1) at (0,-2.5) {$\scriptscriptstyle{E(1) \times (E(1 \times 1)}$};
%\node (C2) at (1.5,-2.5) {$\scriptscriptstyle{E(F(m)) \times (E(F(n)) \times E(F(p)))}$};
...
%\node (C9) at (12,-2) {$\scriptscriptstyle{C7}$};
...
(A5) edge node [above] {$\scriptscriptstyle{\phi'}$} (A6)
(A6) edge node [above] {$\scriptscriptstyle{F'(\psi)}$} (A7)
%(A7) edge node [above] {$\scriptscriptstyle{F'H_{m+_b n,p}}$} (A8)
%(A8) edge node [above] {$\scriptscriptstyle{F'H(\psi)}$} (A9)

(A4) edge node [fill=white] {$\scriptscriptstyle{\phi'}$} (A')
(A') edge node [left] {$\scriptscriptstyle{F'(\alpha)}$} (A'''')
%(A'') edge node [left] {$\scriptscriptstyle{F'H \alpha}$} (A''')
%(A'''') edge node [left] {$\scriptscriptstyle{F'H_{m,n+p}}$} (A')
...
(B5) edge node [above] {$\scriptscriptstyle{\phi'}$} (B6)
(B6) edge node [above] {$\scriptscriptstyle{F'(\psi)}$} (B7)
%(B7) edge node [above] {$\scriptscriptstyle{F'H_{m,n+_c p}}$} (B8)
%(B8) edge node [above] {$\scriptscriptstyle{F'H(\psi)}$} (B9)
...
%(C2) edge node [above] {$\scriptscriptstyle{1 \times E(\phi)}$} (C3)
...
%\node (A3) at (4,1) {$\scriptscriptstyle{A3}$};
%\node (A4) at (6,1) {$\scriptscriptstyle{A4}$};
...
%(A2) edge node [above] {$\scriptscriptstyle{}$} (A3)
%(A3) edge node [above] {$\scriptscriptstyle{}$} (A4)
...
%\node (B4) at (6,-1) {$\scriptscriptstyle{B4}$};
%\node (B5) at (8,-1) {$\scriptscriptstyle{B5}$};
%\node (B6) at (10,-1) {$\scriptscriptstyle{B6}$};
...
%(A4) edge node [fill=white] {$\scriptscriptstyle{F'(H(o)+1)}$} (B3)
...
%\node (A3) at (4,3) {$\scriptscriptstyle{A3}$};
%\node (A4) at (6,3) {$\scriptscriptstyle{A4}$};
%\node (A5) at (8,3) {$\scriptscriptstyle{A5}$};
%\node (A6) at (10,3) {$\scriptscriptstyle{A6}$};

\node (B1) at (0,1) {$\scriptscriptstyle{F'(0')}$};
\node (B2) at (6,1) {$\scriptscriptstyle{F'(H(a+b))}$};
%\node (B3) at (4,1) {$\scriptscriptstyle{B3}$};
%\node (B4) at (6,1) {$\scriptscriptstyle{B4}$};
%\node (B5) at (8,1) {$\scriptscriptstyle{B5}$};
%\node (B6) at (10,1) {$\scriptscriptstyle{B6}$};
...
%(B2) edge node [above] {$\scriptscriptstyle{}$} (B3)
%(B3) edge node [above] {$\scriptscriptstyle{}$} (B4)
%(B4) edge node [above] {$\scriptscriptstyle{}$} (B5)
%(B5) edge node [above] {$\scriptscriptstyle{}$} (B6)
...
%\node (B7) at (12,1) {$\scriptscriptstyle{B7}$};
...
%\node (D7) at (12,-3) {$\scriptscriptstyle{D7}$};
\path[->,font=\scriptsize,>=angle 90]
...
(B5) edge node [above] {$\scriptscriptstyle{F'(\psi)}$} (B6)
%(B6) edge node [above] {$\scriptscriptstyle{}$} (B7)
...
%(C6) edge node [above] {$\scriptscriptstyle{}$} (C7)
...
%(D6) edge node [above] {$\scriptscriptstyle{}$} (D7);
\end{tikzpicture}
\]
Down and then right:
\[
