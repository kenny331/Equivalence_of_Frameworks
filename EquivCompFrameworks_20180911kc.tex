...
\node (C) at (3,0) {$c_3$};
\node (G) at (1.5,-0.5) {$\hat{d} \in F(R(d)+_{c_2}R(d^\prime))$};
%\node (D) at (3,0.5) {$!_c \in F(c)$};
\path[->,font=\scriptsize,>=angle 90]
...
\begin{tikzpicture}[scale=1.5]
\node (A) at (0,0) {$L(c_1)$};
\node (B) at (1.25,0) {$d+_{L(c_2)}d^\prime$};
...
\begin{tikzpicture}[scale=1.5]
\node (A) at (0,0) {$c_1$};
\node (B) at (1.5,0) {$R(d+_{L(c_2)}d^\prime)$};
\node (C) at (3,0) {$c_3$};
\node (G) at (1.5,-0.5) {$d+_{L(c_2)} d^\prime \in F(R(d+_{L(c_2)}d^\prime))$};
%\node (D) at (3,0.5) {$!_c \in F(c)$};
\path[->,font=\scriptsize,>=angle 90]
...
\begin{tikzpicture}[scale=1.5]
\node (A) at (0,0) {$1_\bold{C}$};
\node (B) at (1.25,0) {$R(L(1_\bold{C}))$};
\node (C) at (2.5,0) {$1_\bold{C}$};
\node (D) at (4,0) {$!_{1_\bold{C}} \in F(R(L(1_\bold{C}))) \cong F(1_\bold{C})$};
\path[->,font=\scriptsize,>=angle 90]
...
\node (B) at (2.25,0) {$R(d)+R(d^\prime)$};
\node (C) at (4.5,0) {$c_2+c_2^\prime$};
\node (D) at (2.25,-0.5) {$\hat{d} \in F(R(d)+R(d^\prime)$}; 
%\node (D) at (3,0.5) {$!_c \in F(c)$};
\path[->,font=\scriptsize,>=angle 90]
...
\begin{tikzpicture}[scale=1.5]
\node (A) at (0,0) {$c_1+c_1^\prime$};
\node (B) at (2,0) {$R(d+d^\prime)$};
\node (C) at (4,0) {$c_2+c_2^\prime$};
\node (D) at (2,-0.5) {$d+d^\prime \in F(R(d+d^\prime))$};
%\node (D) at (3,0.5) {$!_c \in F(c)$};
\path[->,font=\scriptsize,>=angle 90]
...
\[
		\begin{tikzpicture}
			...
			\node (d2) at (7.5,1) {$1_{\mathbb{F}\textnormal{Cospan}(\bold{C})} \otimes \mathbb{E}(M_1)$};
			\node (a2) at (-4,1) {$1_\bold{C}+c_1$};
			\node (b2) at (0.5,1) {$1_\bold{C}+R(d_1)$};
			\node (c2) at (5,1) {$1_\bold{C}+c_1^\prime$};
			\node (d3) at (7.5,2) {$\mathbb{E}(M_1)$};
                                \node (a3) at (-4,2) {$c_1$};
			\node (b3) at (0.5,2) {$R(d_1)$};
			\node (c3) at (5,2) {$c_1^\prime$};
			\node (d4) at (7.5,-1) {$\mathbb{E}(1_{ _L \mathbb{C}\textnormal{sp}(\bold{D})} \otimes M_1)$};
                                \node (a5) at (-4,-1) {$1_\bold{C}+c_1^\prime$};
			\node (b5) at (0.5,-1) {$R(L(1_\bold{C})+d_1)$};
			\node (c5) at (5,-1) {$1_\bold{C}+c_1^\prime$};
			\node (d5) at (7.5,-2) {$\mathbb{E}(M_1)$};
                                \node (a6) at (-4,-2) {$c_1$};
			\node (b6) at (0.5,-2) {$R(d_1)$};
