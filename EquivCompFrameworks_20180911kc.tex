...
\node (A) at (0,0) {$X$};
\node (D) at (3,0) {$k^+$};
\node (E) at (4,0) {$\mathbb{E}$};
\node (F) at (5,0) {$\mathbb{V}$};
\path[->,font=\scriptsize,>=angle 90]
...
\node (F) at (5,0) {$W$};
\node (G) at (4,0) {$V$};
\node (E') at (3,-1) {$U^\prime$};
\node (F') at (5,-1) {$W^\prime$};
\node (G') at (4,-1) {$V^\prime$};
\node (A) at (6,0) {$K \in F(V)$};
\node (B) at (6,-1) {$K^\prime \in F(V^\prime)$};
\path[->,font=\scriptsize,>=angle 90]
...
\end{tikzpicture}
\]
together with a morphism of $k$-graphs $\iota \colon F(h)(K) \to K^\prime$ in $F(V^\prime)$.}
\end{enumerate}
...
\node (F) at (5,0) {$L(Y)$};
\node (G) at (4,0) {$P$};
\node (E') at (3,-1) {$L(X^\prime)$};
\node (F') at (5,-1) {$L(Y^\prime)$};
\node (G') at (4,-1) {$P^\prime$};
\path[->,font=\scriptsize,>=angle 90]
(F) edge node[above]{$O$} (G)
...
\node (F) at (5,0) {$Y$};
\node (G) at (4,0) {$Z$};
\node (E') at (3,-1) {$X^\prime$};
\node (F') at (5,-1) {$Y^\prime$};
\node (G') at (4,-1) {$Z^\prime$};
\node (A) at (6,0) {$P \in F(Z)$};
\node (B) at (6,-1) {$P^\prime \in F(Z^\prime)$};
\path[->,font=\scriptsize,>=angle 90]
(F) edge node[above]{$o$} (G)
(E) edge node[left]{$f$} (E')
(F) edge node[right]{$g$} (F')
