...
Let $\OpFib(\A)$ denote the 2-subcategory of the slice $\mathbf{Cat}/ \A$ of opfibrations over $\A$, opfibrations morphisms and natural transformations with vertical components.
