...
\end{tikzpicture}
\]
where $\ell$ is the left unitor of $(\mathsf{A},+,0)$, together with the isomorphism $\iota_{\lambda} \colon F(\ell)(d_{0 \otimes M}) \to d_M$ which is specified by the isomorphism of categories $F(0+b) \cong F(b)$. The right unitor is similar.
