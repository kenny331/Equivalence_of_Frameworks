...
{\chris The above diagram might be a bit overwhelming, but all info is there. Choose which parts are required for a smooth proof!} {\chris Also, iota and letter i look alarmingly similar. Should we change iota to some other distinctive greek letter?}
