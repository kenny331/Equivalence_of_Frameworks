...
\begin{thm}
Let $\mathsf{A}$ be a category with finite colimits and $F \colon \mathsf{A} \to \mathbf{Cat}$ a lax monoidal pseudofunctor. Then there exists a double category $F\mathbb{C}$sp which has:
\begin{enumerate}
\item{objects as those of $\mathsf{A}$,}
