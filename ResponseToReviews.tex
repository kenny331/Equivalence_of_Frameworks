...
concrete examples.} {\chris $\checkmark$} {\kenny $\checkmark$}
...
\textbf{Kenny Courser carefully checked that these really are co/cartesian liftings, but the argument is straightforward uninteresting so we will just 
