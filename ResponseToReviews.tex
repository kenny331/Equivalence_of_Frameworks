...
these errors in detail and fixed them using structured cospans.  See also comment (6) in the second review.} {\chris THIS Is comment (6) in the 
second review. Which comment does this refer to? Or should this last sentence be transferred as is in comment (1) of third review below?}
