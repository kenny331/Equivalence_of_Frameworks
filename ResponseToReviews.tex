...
{\john I changed ``composition of maps'' to ``composition of morphisms'' above because people often use ``map'' to mean a morphism in a category of sets with extra structure, and here we just mean composition of morphisms, or sometimes horizontal 1-cells, which I hope is close enough.  I hope that's okay!}
...
{\john Great.  Except for one thing: I hate footnotes.   If something is worth saying, just say it, don't stick a little number in the text and make the reader decide if it's worth looking down at the bottom of the page to see what this mysterious number means.  That's more distracting than just saying it!   So I moved the comment into the text and merged it into the previous sentence.}
...
\textbf{Kenny Courser carefully checked that these really are co/cartesian liftings, but the argument is straightforward uninteresting so we will just add remarks saying that this can be shown.}   {\john $\checkmark$}
...
{\bf  We have added a remark on page 9 discussing this.}  {\john $\checkmark$}
