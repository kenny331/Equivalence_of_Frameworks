...
{\bf The present work reviews all previous work on decorated and structured cospans in Section 6.  As we mention, our previous paper ``Structured cospans'' fixed the errors in previous work using decorated cospans by using structured cospans instead.   Here we describe how the new improved decorated cospans can also fix those errors.     There may be even more ways to correct these errors, but we do not know them.}    {\john $\checkmark$}
