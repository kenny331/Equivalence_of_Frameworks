...
add remarks saying that this can be shown.}   {\john $\checkmark$} {\chris $\checkmark$}
...
{\bf  We have added a remark on page 9 discussing this.}  {\john $\checkmark$} {\chris $\checkmark$}
