...
{\john The referee was asking about the \emph{semantics} for reaction networks --- that is, dynamical systems!  Reaction networks are the ``syntax'' and dynamical systems are our chosen ``semantics'' for these.  But my reply in boldface was confused --- you're right.  So I've fixed it.  Give me a check mark if you're happy now.}
