...
% in LaTeX
% 2021/04/16 - 4th version sent to Compositionality: version for publication - fixing mistakes
...
In applications, this double functor lets us turn an open Petri net with rates into an open dynamical system as follows.  Given a Petri net with rates and defining $v$ as above, we obtain a system of first-order ordinary differential equations for a time-dependent function $c \maps \R \to \R^S$ 
