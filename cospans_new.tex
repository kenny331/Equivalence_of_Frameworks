...
% in LaTeX
% 2021/03/07 - dealing with referee's comments
...
\end{tikzpicture}
\]
The square at right commutes strictly because $\theta$ is a natural isomorphism.
\end{itemize}
...
If we drop these inflow and outflow terms, we obtain a dynamical system: an autonomous system of coupled nonlinear first-order ordinary differential equations.   In fact these equations are a famous model of infectious disease, the `SIR model', where $S(t)$, $I(t)$ and $R(t)$ describe the populations of susceptible, infected and recovered individuals, respectively.   The inflow and outflow terms allow individuals to enter or leave the population.   This in turn lets us couple the SIR model to other models, and build larger models from smaller pieces.    Indeed, open Petri nets and the mathematics of structured cospan categories have recently been used to develop a software tool for building and manipulating epidemiological models \cite{BFMLP}.  
