...
\begin{proof}[Proof of \cref{thm:decorated_cospans_1}] We apply \cref{lem:shulman} to ....
\end{proof}

\begin{proof}[Proof of \cref{thm:decorated_cospans_2}] We apply \cref{lem:shulman} to ....
\end{proof}
...
{\bf NEW PROOF HERE.}  We apply \cref{lem:shulman} to ....
\end{proof}
