...
\end{enumerate}
<<<<<<< HEAD
The functor $U_1$ is defined on objects by $U_1(a,x,a \xrightarrow{i} U(x))=a$ and on morphisms by $U_1(f,\alpha)=f$. We have a monoidal structure on the comma category $(\A/U)$ where the tensor product of two objects $(a_1,x_1,a_1 \xrightarrow{i_1} U(x_1))$ and $(a_2,x_2,a_2 \xrightarrow{i_2} U(x_2))$ is given by $$(a_1,x_1,a_1 \xrightarrow{i_1} U(x_1)) \otimes (a_2,x_2,a_2 \xrightarrow{i_2} U(x_2)) = (a_1+a_2,x_1+x_2,a_1+a_2 \xrightarrow{i_1+i_2} U(x_1+x_2))$$making use of the natural isomorphism $U(x_1)+U(x_2) \cong U(x_1+x_2)$ which we omit in the above definition. The monoidal unit is given by $(0_\A,0_\X,0_\A \to U(0_\X))$. It is easy to see that the functor $U_1$ can be made into a strict monoidal functor using this tensor product.
=======
The functor $U_1$ is defined on objects by $U_1(a,x,a \xrightarrow{i} U(x))=a$ and on morphisms by $U_1(f,\alpha)=f$. We have a monoidal structure on the comma category $(\A/U)$ where the tensor product of two objects $(a_1,x_1,a_1 \xrightarrow{i_1} U(x_1))$ and $(a_2,x_2,a_2 \xrightarrow{i_2} U(x_2))$ is given by
...
where the natural isomorphism $U(x_1)+U(x_2) \cong U(x_1+x_2)$ is implicit
...
>>>>>>> 6cd9709b18da62758e2e9ca4870d5c70851924a2
