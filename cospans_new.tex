...
We prove both these theorems using the work of Shulman \cite{Shulman2008}, which we recall here.   The concept of `Beck--Chevalley monoidal bifibration' is explained in \cref{subsec:fibrations}.   
...
a pushout, we shall say $\Phi$ is \define{Beck--Chevalley}.  (Shulman  uses the term `strongly co-BC' \cite[Definition 13.21] {Shulman2008}.)
