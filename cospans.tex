...
1\ar[rrrr,"x"'] \&\phantom{A}\&\&\& F(m).
 \end{tikzcd}}
\end{equation}
All this data can be shown to obey the axioms of a double category, using the cospan double category of $\A$ and axioms of the lax monoidal pseudofunctor $F$.
\end{proof}
