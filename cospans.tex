...
$I\to\lE(I)$ is the identity. {\chris It is not the identity! Fix after we decide: keep \cref{eq:monoidalunitFCsp} as is and make this into an isomorphism using $F(1)\cong 1_F$ or change \cref{eq:monoidalunitFCsp} to the actual $U_0$ in the notation therein, and have equality of structures here.}
