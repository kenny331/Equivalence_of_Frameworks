...
\& F(m_1)\times F(n_2)\times F(m_2)\times F(n_2)\ar[dd,"1\times\beta\times1"]\ar[ddrr,phantom,"\cong"]\ar[rr,"\phi_{m_1,n_1}\times\phi_{m_2,n_2}"] \&\& F(m_1+n_1)\times F(m_2+n_2)\ar[rr,"\phi_{m_1+n_1,m_2+n_2}"] \&\& F(m_1+n_1+m_2+n_2)\ar[dd,"F\psi"]\ar[ddll,"F(1\times\beta\times1)"'] \\
...
%			\node (a) at (-4,0) {$a+a'$};
			\node (b) at (1,0) {$(m_1+n_1) +_{(b+b')} (m_2+n_2)$};
			\node (c) at (8,0) {$ (x_2\oplus y_2)\odot (x_1\oplus y_1)  \in F((m_1+n_1)+_{b+b'}(m_2+n_2))$};
%			\node (a2) at (-4,1) {$a'+a$};
			\node (b2) at (1,1) {$(n_1+m_1) +_{(b'+b)} (n_2+m_2)$};
			\node (c2) at (8,1) {$(y_2\oplus x_2)\odot(y_1\oplus x_1) \in F((n_1+m_1)+_{b'+b}(n_2+m_2))$};
%                            \node (a3) at (-4,2) {$a'+a$};
			\node (b3) at (1,2) {$(n_1 +_{b'} n_2) + (m_1 +_b m_2)$};
			\node (c3) at (8,2) {$(y_2 \odot y_1) \oplus (x_2 \odot x_1) \in F((n_1+_{b'} n_2)+(m_1+_b m_2))$};
%                                \node (a5) at (-4,-1) {$a+a'$};
			\node (b5) at (1,-1) {$(m_1+_b m_2) + (n_1+_{b'} n_2)$};
			\node (c5) at (8,-1) {$(x_2 \odot x_1) \oplus (y_2 \odot y_1) \in F((m_1+_b m_2)+(n_1+_{b'} n_2))$};
%                                \node (a6) at (-4,-2) {$a'+a$};
			\node (b6) at (1,-2) {$(n_1 +_{b'} n_2) + (m_1 +_b m_2)$};
			\node (c6) at (8,-2) {$(y_2 \odot y_1) \oplus (x_2 \odot x_1) \in F((n_1+_{b'} n_2)+(m_1+_b m_2))$};
			\path[->,font=\scriptsize,>=angle 90]
%			(a) edge node[above]{$$} (b)
%			(c) edge node[above]{$$} (b)
%                                (a2) edge node[above]{$$} (b2)
...
\node (B'') at (9,-1.5) {$\scriptstyle{F(n_1+_{b'}n_2)+F(m_1+_b m_2)}$};
...
(B) edge node [above] {$F(\psi)$} (C)
(B'') edge node [below] {$\phi_{n_1+_{b'}n_2,m_1+_bm_2}$} (C'')
(B') edge node [above] {$\phi_{m_1+_bm_2,n_1+_{b'}n_2}$} (C')
