...
\begin{rmk}\label{rmk:interestingrmk}
...
\end{align*}
which are uniquely isomorphic $F(\iota_m)x+F(\iota_{m'})\cong \phi_{m,m'}(x,x')$ in an analogous way to \cref{eq:isomorphismdiag}, as also discussed in \cref{rmk:interestingrmk}.
...
again by \cref{eq:explicitstructure2} and the discussion in \cref{rmk:interestingrmk}.
