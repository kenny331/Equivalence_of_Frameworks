...
All axioms for a symmetric monoidal category can be verified, see \cite[Theorem 4.1.3]{CourserThesis}, and it is easy to see that with these structures, the source and target functors $S,T\colon F\lCsp_1\to F\lCsp_0$ are symmetric strict monoidal.
