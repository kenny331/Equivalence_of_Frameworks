...
% in LaTeX
% 2021/2/15 - changes after first arXiv version
...
The category of objects $F\lCsp_0$ is simply $\A$, whereas $F$-decorated cospans and maps between them form the category of arrows $F\lCsp_1$. The (vertical) composite of two maps of $F$-decorated cospan is 
...
\one\ar[r,"\phi_0"]\ar[dr,phantom,near start,"{\scriptstyle\stackrel{\cref{eq:unitality}}{\cong}}"]\ar[d,"\phi_0\times\phi_0"'] & F(0)\ar[dr,phantom,"{\scriptstyle\stackrel{\cref{eq:pseudonaturality}}{\cong}}"]\ar[r,"F(!_{a+b})"] & F(a+b)\ar[d,"1"] \\
F(0)\times F(0)\ar[r,"F(!_a)\times F(!_b)"']\ar[ur,"\phi_{0,0}"description] & F(a)\times F(b)\ar[r,"\phi_{a,b}"'] & F(a+b)
\end{tikzcd}
\end{displaymath}
%%% changed F(1) to 1 in the righthand vertical arrow - jb
