...
\begin{cor}
Let $\A$ be a category with finite colimits and $F \maps (\A, +) \to \Cat$ a symmetric lax monoidal pseudofunctor.  Thenthere exists a symmetric monoidal category $F\textnormal{Csp}$ which has:
\begin{enumerate}
\item{objects as those of $\mathsf{A}$ and}
