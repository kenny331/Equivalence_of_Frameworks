...
\begin{proof}  CITE A PROOF!!!  \end{proof}
...
A \define{monoidal double category} is a pseudomonoid in $\Dbl$. Explicitly, it is a double category equipped with double functors $\otimes \maps \lD \times \lD \to \lD$ and $I \maps 1 \to \lD$ where $1$ is the terminal double category, along with invertible transformations called the \define{associator}:
\[  \alpha \maps \otimes \, \circ \; (1_{\lD} \times \otimes ) \Rightarrow \otimes \; \circ \; (\otimes \times 1_{\lD}) ,\]
\define{left unitor}:
\[ \ell \maps \otimes \, \circ \; (1_{\lD} \times I) \Rightarrow 1_{\lD} ,\]
and \define{right unitor}:
\[ r \maps \otimes \,\circ\; (I \times 1_{\lD}) \Rightarrow 1_{\lD} \]
...
Unpacking these definitions further one obtains a large number of diagrams \cite{HS}.   
