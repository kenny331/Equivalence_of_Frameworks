...
\begin{defn}
Two pseudo double functors $\lF \colon \lA \to \lX$ and $\mathbb{G} \colon \lX \to \lA$ form a \define{double equivalence} if there exist double natural transformations $\mathbb{G} \lF \cong 1_\lA$ and $\lF \mathbb{G} \cong 1_\lX$.
\end{defn}
