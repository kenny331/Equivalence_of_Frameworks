...
\end{tikzcd}}
\end{equation}
where the unnammed isomorphisms are appropriate composites of the pseudoassociativity of $F$ \cref{eq:omega}. The result now follows from lengthy pasted diagram calculations using the axioms of a sylleptic lax monoidal pseudofunctor.
\begin{comment}
