...
These 2-equivalences further restrict to the case when the Grothendieck category $(X,\otimes)$ is specifically cocartesian monoidal itself. In that case, opfibrations $(\X,+)\to(\A,+)$ that (strictly) preserve (chosen) coproducts and initial object
