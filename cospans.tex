...
is established by the following theorem. We denote by $\bicat{fcocCat}$ the 2-category of finitely cocomplete categories and finitely cocontinuous functors.

\begin{thm}\label{Equiv}
Suppose $\ca{A}$ is a finitely cocomplete category and $(F,\phi,\phi_0)\colon(\ca{A},+,0) \to (\bicat{Cat},\times,\mathbf{1})$ is a symmetric lax monoidal pseudofunctor, which factors through $\bicat{fcocCat}$ as an ordinary pseudofunctor. 
