...
Suppose $\A$ has finite colimits and $F \maps (\A,+) \to (\Cat,\times)$ is a symmetric lax monoidal pseudofunctor. If the corresponding ordinary pseudofunctor %(via the monoidal Grothendieck construction) {\chris SHOULD THIS PARENTHESIS STAY OR NOT?} 
