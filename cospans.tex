...
\end{equation}
This can always be achieved by replacing $F$ by an equivalent pseudofunctor that strictly preserves identity morphisms \cite[Proposition 5.2]{LP}.  We do this merely to reduce the size of  our diagrams; the reader can reinsert the morphism $F(!_0)$ where needed. %%% see if you like this!  - jb 
The associator in is formed as follows: for three objects
