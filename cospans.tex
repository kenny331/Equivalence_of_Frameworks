...
\end{array}
\]
where $I_j(t)$ and $O_j(t)$ are arbitrary smooth functions of time, which describe inflows and outflows at the points $i_j \in X$ and $o_j \in Y$.
...
{\chris Changed : to $|$ in the set, is that OK?}
