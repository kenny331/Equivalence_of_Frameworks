...
%%%Christina: we do not have any such information at this point! We have not talked about the categories F(a) being cocomplete, and it's not deduced from the assumptions. We will show this is the case much later!
...
It can be verified with this structure, $F\lCsp$ is indeed a symmetric monoidal double category, namely all coherence laws are satisfied. The details can be found in \cite[Theorem 4.1.3]{CourserThesis}, but in order to give the reader a sense of what these checks entail, we provide an explicit proof of the fact that the braiding is a transformation of double categories, i.e. establish the commutativity of the left-hand side diagram \cref{eq:braidingaxiom}, in \cref{eq:proofofaxiom} so as to not interrupt the main narrative.
...
Our construction gives not only decorated cospan double categories, but maps betwen these as in \cref{def:doublefun}.
...
\subsection{Coherence law for \cref{DC}}\label{eq:proofofaxiom}
