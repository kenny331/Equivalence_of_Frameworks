...
This theorem should generalize to the case when $\theta$ is a pseudonatural
isomorphism, but the weaker version suffices for our application in \cref{subsec:petrirates}.
...
\end{enumerate}
Given these conditions, for any choice of $\J$-colimits in $\A$ the $\J$-colimits in $\X$ can be chosen so that $U$ strictly preserves them.
\end{lem}
