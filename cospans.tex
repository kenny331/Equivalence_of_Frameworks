...
%Moreover, symmetric monoidal opfibrations are equivalent to symmetric monoidal opindexed categories, and when the base is cocartesian monoidal these also correspond to pseudofunctors into $\SMC$.
\end{lem}
